...
public class TicketResource
{
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new ticket, or with status
     * {@code 400 (Bad Request)} if the ticket has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated ticket, or with status
     * {@code 400 (Bad Request)} if the ticket is not valid, or with status {@code 500 (Internal Server Error)} if the
     * ticket couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/tickets")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the ticket, or with status {@code
     * 404 (Not Found)}.
     */
